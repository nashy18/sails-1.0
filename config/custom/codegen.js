module.exports.codegen = {
    ...
    queryParentCustomerdefTemplate: 'queries/parentcustomerdef',
    queryChildCustomerdefTemplate: 'queries/customerdef',
    querychildCustomerbyIddefTemplate:'queries/childcustomerbyiddef'
